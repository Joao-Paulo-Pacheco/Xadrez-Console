...
namespace xadrez
{
    class PartidaXadrez
    {
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("Não existe peça na posicação de origem escolhida!");
            }
            ...
            {
                throw new TabuleiroException("Não há movimentos possíveis para esta peca!");
            }
        }
                ...
                for (int i=0; i<tab.linhas; i++)
                {
                    for (int j=0; j<tab.colunas; j++)
                    {
                        if (mat[i, j])
                        {
                            ...
                            Peca pecaCaputada = executeMovimento(origem, destino);
